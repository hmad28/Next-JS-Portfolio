...
import { Check } from "../app/icon/check"; // ✅ Path ini harusnya udah ada di project kamu
...
export default function ProfileCard() {
  ...
  return (
    <div className="absolute p-1.5 md:p-2 2xl:p-3 w-[160px] lg:w-[260px] 2xl:w-[350px] rounded-3xl md:rounded-4xl bg-white bottom-5 left-7 shadow-lg md:left-15 md:bottom-10 transition-transform duration-300 hover:-translate-y-2">
      <Image
        ...
        priority
        sizes="(max-width: 768px) 160px, (max-width: 1536px) 260px, 350px"
      />
